...
export const CodeSplitChunks = {
  ...
  AdminDashboard: dynamic(
    () => import('../app/admin/dashboard/page').catch(() => ({ default: () => <div>Error loading dashboard</div> })),
    { ssr: false }
  ),

  // Product pages
  ProductDetail: dynamic(
    () => import('../app/products/[id]/page').catch(() => ({ default: () => <div>Error loading product</div> })),
    { ssr: true }
  ),

  // User pages
  AccountPage: dynamic(
    () => import('../app/account/page').catch(() => ({ default: () => <div>Error loading account</div> })),
    { ssr: false }
  ),

  WishlistPage: dynamic(
    () => import('../app/wishlist/page').catch(() => ({ default: () => <div>Error loading wishlist</div> })),
    { ssr: false }
  ),

  CheckoutPage: dynamic(
    () => import('../app/checkout/page').catch(() => ({ default: () => <div>Error loading checkout</div> })),
    { ssr: false }
  ),
};
